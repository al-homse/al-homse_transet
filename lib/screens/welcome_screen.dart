...
import 'idle_timeout_wrapper.dart'; // استيراد ويدجت مؤقت عدم النشاط
...
class _WelcomeScreenState extends State<WelcomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // تغليف الشاشة بـ IdleTimeoutWrapper لمراقبة الخمول وتتبع نشاط المستخدم
    return IdleTimeoutWrapper(
      timeoutDuration: const Duration(minutes: 5), // مدة الخمول (5 دقائق)
      child: Scaffold(
        drawer: AppDrawer(
          userName: _userName,
